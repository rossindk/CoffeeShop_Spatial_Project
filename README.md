...
This project demonstrates how spatial data integration and SQL-based analysis can be applied to evaluate urban service accessibility. The workflow reflects real-world GIS practices used in:
